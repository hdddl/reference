...
[SS7](./docs/SS7.md)<!--rehype:style=background: #86A8E7;-->  
<!--rehype:class=home-card-->
...
[C#](./docs/cs.md)<!--rehype:style=background: rgb(6 147 13);-->  
...
[Django](./docs/djiango.md)<!--rehype:style=background: rgb(12 75 51);&data-lang=Python--> 
[Flask](./docs/flask.md)<!--rehype:style=background: rgb(210 168 255);&data-lang=Python--> 
[Flutter](./docs/flutter.md)<!--rehype:style=background: rgb(150 220 254);&data-lang=Dart-->  
...
[Java](./docs/java.md)<!--rehype:style=background: rgb(211 55 49);&data-info=👆看看还缺点儿什么？-->  
[Julia](./docs/julia.md)<!--rehype:style=background: rgb(26 188 156);&data-info=👆看看还缺点儿什么？-->  
[Kotlin](./docs/kotlin.md)<!--rehype:style=background: rgb(211 55 49);&data-info=👆看看还缺点儿什么？-->  
[Kubernetes](./docs/kubernetes.md)<!--rehype:style=background: rgb(51 113 227);&data-info=👆看看还缺点儿什么？-->  
[LaTeX](./docs/latex.md)<!--rehype:style=background: rgb(0 128 128);>  
[Laravel 8](./docs/laravel.md)<!--rehype:style=background: rgb(249 50 44);&data-lang=PHP-->  
[Markdown](./docs/markdown.md)<!--rehype:style=background: rgb(103 61 156);-->  
[MATLAB](./docs/matlab.md)<!--rehype:style=background: rgb(0 118 168);>  
...
[Pytorch](./docs/pytorch.md)<!--rehype:style=background: rgb(238 76 44);&data-lang=Python&data-info=👆看看还缺点儿什么？-->  
<!--rehype:class=home-card-->
...
[ADB, Android Debug Bridge](./docs/adb.md)<!--rehype:style=background: rgb(238 0 0);&data-lang=Android&data-info=👆看看还缺点儿什么？-->  
[Ansible](./docs/ansible.md)<!--rehype:style=background: rgb(238 0 0);&data-lang=RedHat&data-info=👆看看还缺点儿什么？-->  
...
[pacman](./docs/pacman.md)<!--rehype:style=background: rgb(24 147 209);&class=tag&data-lang=archlinux>  
...
[IntelliJ IDEA](./docs/intelli-j-idea.md)<!--rehype:style=background: rgb(223 148 0);&data-lang=Java-->  
...
[Gitlab CI/CD](./docs/gitlab-ci.md)<!--rehype:style=background: rgb(226 67 41);>  
